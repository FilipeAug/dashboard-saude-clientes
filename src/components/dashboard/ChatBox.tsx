...
export default function ChatBox() {
  ...
  return <Card className="card-gradient flex flex-col h-[400px]">
      ...
      <CardFooter className="pt-0">
        <div className="flex w-full gap-2">
          <Input placeholder="Digite sua mensagem..." value={inputValue} onChange={e => setInputValue(e.target.value)} onKeyPress={handleKeyPress} className="flex-grow" />
